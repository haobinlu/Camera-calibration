/********************************************************************************
** Form generated from reading UI file 'pic_hard_syncrzlnRE.ui'
**
...
#ifndef PIC_HARD_SYNCRZLNRE_H
#define PIC_HARD_SYNCRZLNRE_H
...
public:
    ...
    void setupUi(QMainWindow *pic_hard_syncClass)
    {
        ...
        pic_hard_syncClass->resize(1442, 879);
...
" }"));
        ...
        label_NO->setGeometry(QRect(120, 70, 91, 31));
        QFont font4;
        ...
        lineEdit_NO->setGeometry(QRect(220, 70, 113, 31));
        ...
        label_TCP = new QLabel(groupBox_20);
        label_TCP->setObjectName(QString::fromUtf8("label_TCP"));
        label_TCP->setGeometry(QRect(100, 120, 111, 31));
        label_TCP->setFont(font4);
        label_TCP_status = new QLabel(groupBox_20);
        label_TCP_status->setObjectName(QString::fromUtf8("label_TCP_status"));
        label_TCP_status->setGeometry(QRect(220, 110, 171, 51));
        label_TCP_status->setFont(font4);
        label_TCP_status->setLayoutDirection(Qt::LeftToRight);
        label_TCP_status->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    ...
    void retranslateUi(QMainWindow *pic_hard_syncClass)
    {
        ...
        label_TCP->setText(QCoreApplication::translate("pic_hard_syncClass", "TCP\350\277\236\346\216\245\346\203\205\345\206\265\357\274\232", nullptr));
        label_TCP_status->setText(QString());
