...
class StereoCalibration(object):
    def __init__(self):
        self.imagesL = self.read_images('../data/2/RGBD_0/rgb')
        self.imagesR = self.read_images('../data/2/RGBD_1/rgb')
    ...
    def calibration_photo(self):
        ...
        # 可视化角点
        image_l = cv2.imread('../data/2/RGBD_1/rgb/0.jpg')
    ...
    def cal_error(self, world_position, image_position, mtx, dist, rvecs, tvecs):
        ...
        for i in range(len(world_position)):
            image_position2, _ = cv2.projectPoints(world_position[i],  [i], tvecs[i], mtx, dist)
